...
class Group_User(db.Model):
    ...
    user = relationship(User, backref=backref("group_user", cascade="all, delete-orphan"))
    group = relationship(Group, backref=backref("group_user", cascade="all, delete-orphan"))
